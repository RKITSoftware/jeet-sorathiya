...
CREATE TABLE TRA01 (
    ...
    A01F02 VARCHAR(50) NOT NULL,
    A01F03 VARCHAR(50) NOT NULL,
    A01F04 VARCHAR(50) NOT NULL,
    A01F05 VARCHAR(50) NOT NULL,
    A01F06 VARCHAR(50) NOT NULL
);

CREATE TABLE PSG01 (
    G01F01 INT PRIMARY KEY AUTO_INCREMENT,
    G01F02 VARCHAR(50) NOT NULL,
    G01F03 INT NOT NULL
);

CREATE TABLE BOK01 (
    K01F01 INT PRIMARY KEY AUTO_INCREMENT,
    K01F02 INT NOT NULL,
    K01F03 INT NOT NULL,
    K01F04 DATE NOT NULL,
    FOREIGN KEY (K01F02)
        REFERENCES TRA01 (A01F01),
    FOREIGN KEY (K01F03)
        REFERENCES PSG01 (G01F01)
);
